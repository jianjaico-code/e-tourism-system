...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FuncPlacesPageModule", function() { return FuncPlacesPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__func_places__ = __webpack_require__(793);
...
var FuncPlacesPageModule = /** @class */ (function () {
    function FuncPlacesPageModule() {
    }
    FuncPlacesPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["J" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__func_places__["a" /* FuncPlacesPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__func_places__["a" /* FuncPlacesPage */]),
            ],
        })
    ], FuncPlacesPageModule);
    return FuncPlacesPageModule;
}());

//# sourceMappingURL=func-places.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FuncPlacesPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_firebase__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_firebase___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_firebase__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash__ = __webpack_require__(794);
...
var map;
var FuncPlacesPage = /** @class */ (function () {
    function FuncPlacesPage(navCtrl, afAuth, navParams, viewCtrl, loadingCtrl, alertCtrl) {
    ...
    FuncPlacesPage.prototype.closeModal = function () {
        this.viewCtrl.dismiss();
    };
    FuncPlacesPage.prototype.initCategory = function () {
        var _this = this;
        var ref = __WEBPACK_IMPORTED_MODULE_2_firebase__["database"]().ref('category');
        ref.on('value', function (category) {
            var arr = [];
            ...
            _this.categoryVal = arr;
        });
    };
    FuncPlacesPage.prototype.initData = function () {
        var _this = this;
        if (this.status) {
    ...
    FuncPlacesPage.prototype.getPicture = function () {
        var _this = this;
    ...
    FuncPlacesPage.prototype.initMap = function () {
        var _this = this;
        var Gingoog = { lat: 8.8230, lng: 125.0976 };
        navigator.geolocation.getCurrentPosition(function (location) {
            ...
            map.addListener('click', function (e) {
                ...
                var pos = { lat: newPos.lat, lng: newPos.lng };
                console.log(pos);
    ...
    FuncPlacesPage.prototype.pin = function () {
        var Gingoog = new google.maps.LatLng($('#latVal').val(), $('#longVal').val());
    ...
    FuncPlacesPage.prototype.showCategory = function () {
        var _this = this;
        var ref = __WEBPACK_IMPORTED_MODULE_2_firebase__["database"]().ref('category');
        var alert = this.alertCtrl.create();
        ...
        alert.addButton({
            ...
            handler: function (data) {
                _this.category = data;
                ref.once('value', function (category) {
                    category.forEach(function (category) {
                        if (data == category.val().cat_val) {
                            _this.categoryDesc = category.val().name;
                        }
                    });
                });
            }
    ...
    FuncPlacesPage.prototype.detectFiles = function (event) {
        this.selectedFiles = event.target.files;
    };
    FuncPlacesPage.prototype.detectFilesAttachment = function (event) {
        this.selectedFilesAttachement = event.target.files;
    };
    FuncPlacesPage.prototype.savePhotoToStorageAttachment = function () {
        var _this = this;
        if (!this.status) {
            var files = this.selectedFilesAttachement;
            __WEBPACK_IMPORTED_MODULE_3_lodash__["range"](files.length);
            __WEBPACK_IMPORTED_MODULE_3_lodash__["each"](files, function (idx) {
                var storageRef = __WEBPACK_IMPORTED_MODULE_2_firebase__["storage"]().ref('/Establishment Permits Picture/' + _this.name.value + '/' + idx.name);
                storageRef.put(idx).then(function (snapshot) {
                    return snapshot.ref.getDownloadURL();
                }).then(function (downloadURL) {
                    console.log("Successfully uploaded file and got download link for Permits - " + downloadURL);
                    _this.permitsArrImage.push(downloadURL);
                    return downloadURL;
    ...
    FuncPlacesPage.prototype.savePhotoToStorage = function () {
        var _this = this;
        if (!this.status) {
            ...
            if (this.userType == 2) {
                ...
                __WEBPACK_IMPORTED_MODULE_3_lodash__["each"](files, function (idx) {
                    console.log(idx);
                    var storageRef = __WEBPACK_IMPORTED_MODULE_2_firebase__["storage"]().ref('/Establishment Picture/' + _this.name.value + '/' + idx.name);
                    storageRef.put(idx).then(function (snapshot) {
                        return snapshot.ref.getDownloadURL();
                    }).then(function (downloadURL) {
                        console.log("Successfully uploaded file and got download link - " + downloadURL);
                        _this.arrImage.push(downloadURL);
                        return downloadURL;
                    }).catch(function (error) {
                        _this.uploadLoad.dismiss();
                        var alert = _this.alertCtrl.create({
                ...
                this.imageValidator = setInterval(function () {
                    _this.validatingUploadedImages();
                    console.log(_this.arrImage.length);
                }, 1000);
            }
            else {
                var files = this.selectedFiles;
            ...
            __WEBPACK_IMPORTED_MODULE_3_lodash__["each"](files, function (idx) {
                console.log(idx);
                var storageRef = __WEBPACK_IMPORTED_MODULE_2_firebase__["storage"]().ref('/Establishment Picture/' + _this.data.name + '/' + idx.name);
                storageRef.put(idx).then(function (snapshot) {
                    return snapshot.ref.getDownloadURL();
                }).then(function (downloadURL) {
                    console.log("Successfully uploaded file and got download link - " + downloadURL);
    ...
    FuncPlacesPage.prototype.validatingUploadedImages = function () {
        var _this = this;
        if (this.userType == 2) {
            if (!this.status) {
                if (this.selectedFiles.length == this.arrImage.length && this.selectedFilesAttachement.length == this.permitsArrImage.length) {
                    this.uploadLoad.dismiss().then(function () {
                        _this.stopImageValidator();
                        _this.uploadLoad.dismiss();
    ...
    FuncPlacesPage.prototype.stopImageValidator = function () {
        clearInterval(this.imageValidator);
    };
    FuncPlacesPage.prototype.checkData = function (key) {
        if (key) {
            if (this.userType == 3) {
                if (this.name.value == "") {
                    this.validData = true;
    ...
    FuncPlacesPage.prototype.saveEstablishment = function () {
        var _this = this;
        this.checkData(true);
        if (!this.validData) {
            if (this.selectedFiles.length < 3) {
                ...
                this.uploadLoad.onDidDismiss(function () {
                    var ref = __WEBPACK_IMPORTED_MODULE_2_firebase__["database"]().ref('establishment');
                    if (_this.userType == 3) {
                        ref.push({
                            ...
                            website: "",
                            images: _this.arrImage,
                            permits: "",
                            phone: "",
                            description: _this.description.value,
                            category: "4",
                            userEmail: _this.user,
                            userType: _this.userType,
                            status: _this.placeStatus.value,
                            averageRate: "0",
                            peopleRated: "0"
                        }).then(function () {
                            // this.viewCtrl.dismiss();
                        ...
                        ref.push({
                            ...
                            latitude: _this.position.lat,
                            longitude: _this.position.lng,
                            website: _this.website.value,
                            images: _this.arrImage,
                            permits: _this.permitsArrImage,
    ...
    FuncPlacesPage.prototype.updateEstablishment = function () {
        var _this = this;
            ...
            if (!this.selectedFiles) {
                ...
                this.uploadLoad.onDidDismiss(function () {
                    ref.set({
                        ...
                        averageRate: _this.data.averageRate,
                        peopleRated: _this.data.peopleRated
                    });
                });
            }
            else {
                if (this.updatePicture) {
                    this.savePhotoToStorage();
                    this.uploadLoad.onDidDismiss(function () {
                        _this.arrImage.forEach(function (element) {
                            _this.data.images.push(element);
                        });
                    ...
                    if (this.selectedFiles.length < 3) {
                        var alert_22 = this.alertCtrl.create({
                            message: "Please add 3 or more.",
                            buttons: ["Ok"]
                        });
                        alert_22.present();
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(42), __webpack_require__(795)(module)))
