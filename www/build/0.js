...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__establishment__ = __webpack_require__(791);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ionic2_rating__ = __webpack_require__(758);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ionic2_rating_module__ = __webpack_require__(759);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ionic2_rating__ = __webpack_require__(757);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic2_rating__ = __webpack_require__(757);
...
var EstablishmentPage = /** @class */ (function () {
    ...
    EstablishmentPage.prototype.initData = function () {
        var _this = this;
        var ref = __WEBPACK_IMPORTED_MODULE_4_firebase__["database"]().ref('category');
        ref.once('value', function (category) {
            category.forEach(function (category) {
                if (_this.user == 2 || _this.user == 3) {
                    if (_this.navParams.data.data.category == category.val().name) {
                        _this.cat = category.val().cat_val;
                    }
                }
                else {
                    if (_this.navParams.data.category == category.val().name) {
                        _this.cat = category.val().cat_val;
                    }
                }
            });
    ...
    EstablishmentPage.prototype.initMap = function () {
        ...
        var Establishment = new google.maps.LatLng(me.data.latitude, me.data.longitude);
