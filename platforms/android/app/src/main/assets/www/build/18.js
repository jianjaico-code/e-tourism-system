...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mapping__ = __webpack_require__(771);
...
var MappingPage = /** @class */ (function () {
    function MappingPage(navCtrl, platform, navParams, loadingCtrl) {
        var _this = this;
    ...
    MappingPage.prototype.initializeMapping = function (data) {
        ...
        var me = this;
        me.readData = data;
        var Establishment = { lat: data.latitude, lng: data.longitude };
    ...
    MappingPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* Platform */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* LoadingController */]])
    ], MappingPage);
    return MappingPage;
}());
