...
var BusinessmanPage = /** @class */ (function () {
    function BusinessmanPage(navCtrl, navParams, afAuth, modalCtrl) {
        this.navCtrl = navCtrl;
    ...
    BusinessmanPage.prototype.ionViewDidLoad = function () {
        var _this = this;
...
var AdminPage = /** @class */ (function () {
    function AdminPage(navCtrl, menuCtrl, alertCtrl, modalCtrl, loadingCtrl, authData, afAuth) {
        var _this = this;
        this.navCtrl = navCtrl;
        ...
        var loader = this.loadingCtrl.create({
            content: 'Please Wait, Initializing Data...',
            spinner: 'crescent',
            duration: 2000
        });
        loader.present();
    ...
    AdminPage.prototype.initData = function () {
        var _this = this;
        var ref = __WEBPACK_IMPORTED_MODULE_2_firebase__["database"]().ref('user/');
        ref.on('value', function (data) {
            var arr = [];
...
var MenuPage = /** @class */ (function () {
    function MenuPage(navCtrl, data, loadingCtrl, authData) {
        this.navCtrl = navCtrl;
        this.data = data;
        this.loadingCtrl = loadingCtrl;
        this.authData = authData;
    ...
    MenuPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_2__providers_auth_auth__["a" /* AuthProvider */]])
    ], MenuPage);
    return MenuPage;
}());
